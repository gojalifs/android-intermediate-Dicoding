...
import com.fas.dev.latihan.advancedtesting.databinding.ItemNewsBinding
import com.fas.dev.latihan.advancedtesting.utils.DateFormatter
import java.util.TimeZone

class NewsAdapter(private val onItemClick: (NewsEntity) -> Unit) :
    ListAdapter<NewsEntity, NewsAdapter.MyViewHolder>(
        DIFF_CALLBACK
    ) {
