...
import com.dicoding.picodiploma.mycamera.utils.Utils.createCustomTempFile
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            val cameraProvier = cameraProviderFuture.get()
            ...
            try {
                cameraProvier.unbindAll()
                cameraProvier.bindToLifecycle(
                    this,
                    cameraSelector,
                    preview,
                    imageCapture
    ...
    companion object {
        ...
        const val EXTRA_CAMERAX_IMAGE = "CameraX"
